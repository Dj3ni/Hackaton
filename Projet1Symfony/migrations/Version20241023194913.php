 ...
 */
final class Version20241023194913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asset_story (id INT AUTO_INCREMENT NOT NULL, story_node_id INT DEFAULT NULL, asset_id INT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, path VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, INDEX IDX_7E0D2A7F15F10F55 (story_node_id), INDEX IDX_7E0D2A7F5DA1941 (asset_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
